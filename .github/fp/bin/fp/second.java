...
int n=0;
	...
	public second() {
		...
		JLabel q1 = new JLabel("2. When was COVID-19 declared as a public health emergency ?");
		...
		JRadioButton rb1 = new JRadioButton("11.02.2020");
		...
		JRadioButton rb2 = new JRadioButton("30.01.2020");
		...
		contentPane.add(rb2);
		grp1.add(rb2);
		JRadioButton rb3 = new JRadioButton("31.12.2020");
